...
pair<vector<individuo::value_type>, pair<float, float>> BusquedaLocalAprendizaje(vector<individuo::value_type> solucion, const muestra &training, const muestra &test, const unsigned int & seed, unsigned int &n_ejecuciones) {
  ...
  typename individuo::size_type i, j ,k = 0;
